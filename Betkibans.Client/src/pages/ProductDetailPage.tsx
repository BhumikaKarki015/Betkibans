            ...
            <div className="py-2 border-bottom" style={{ backgroundColor: '#EDEAE3' }}>
                <div className="container">
                    <ol className="breadcrumb mb-0 small">
                        ...
                        <li className="breadcrumb-item active text-truncate" style={{ maxWidth: 160 }} aria-current="page">
                            {product.name}
                        </li>
                    </ol>
                </div>
            ...
            <div className="container py-3 py-md-4">
                ...
                <div className="row g-3 g-md-4 mb-4 mb-md-5">
                    ...
                    <div className="col-12 col-lg-7">
                        ...
                        {/* Title */}
                        <h1 className="fw-bold mb-2 lh-sm" style={{ fontSize: 'clamp(1.3rem, 3.5vw, 1.6rem)' }}>
                            {product.name}
                        </h1>

                        {/* Stars + review count */}
                        <div className="d-flex align-items-center gap-2 mb-3 flex-wrap">
                            <Stars rating={Math.round(avgRating)} size={17} />
                            <span className="fw-semibold small" style={{ color: '#2D6A4F' }}>
                        ...
                        {/* Price */}
                        <div className="product-detail-price d-flex align-items-center gap-2 gap-md-3 mb-3 mb-md-4 flex-wrap">
                            <span className="fw-bold" style={{ fontSize: 'clamp(1.4rem, 4vw, 1.8rem)', color: '#2D6A4F' }}>
                            ...
                            {hasDiscount && (
                                <>
                                    ...
                                    <span className="badge fw-semibold px-2 py-1"
                                          style={{ backgroundColor: '#FDECEA', color: '#C0392B', fontSize: 12 }}>
                                        {discountPercent}% OFF
                                    </span>
                                </>
                            )}
                        ...
                        <div className="d-grid gap-2 mb-3" style={{ maxWidth: 480 }}>
                            <div className="product-cta-row d-flex gap-2">
                                ...
                                <button className="btn btn-lg flex-shrink-0"
                        ...
                        <div className="rounded-3 p-3" style={{ backgroundColor: '#EDEAE3' }}>
                            ...
                            <ul className="list-unstyled mb-0">
                                {[
                                    ...
                                    ...(product.weight ? [`Weight capacity: ${product.weight} kg`] : []),
                                ].map((feat, i) => (
                ...
                <div className="mb-4 mb-md-5">
                    <div className="border-bottom mb-3 mb-md-4">
                        <div className="product-tabs d-flex gap-0"
                            ...
                            {tabs.map(tab => (
                                <button key={tab.key}
                                        className="btn border-0 pb-3 fw-medium flex-shrink-0"
                                        style={{
                                            borderRadius: 0,
                        ...
                        <div className="row">
                            <div className="col-12 col-lg-7">
                                {[
                                    ...
                                    <div key={i} className="rounded-3 p-3 p-md-4 mb-3" style={{ backgroundColor: '#EDEAE3' }}>
                    ...
                    {activeTab === 'shipping' && (
                        <div className="row">
                            <div className="col-12 col-lg-7">
                                {[
                                    {
                                        icon: 'bi-truck', title: 'Delivery Information',
                                        items: ['3–5 business days (Kathmandu Valley)', '5–10 business days (Outside valley)', 'Free shipping on orders above NPR 50,000', 'Standard shipping: NPR 500'],
                                    },
                                    {
                                        icon: 'bi-arrow-return-left', title: 'Returns & Refunds',
                                        items: ['7-day return policy for damaged products', 'Original packaging required for returns', 'Contact seller within 48 hours of receiving'],
                                    },
                                ].map((s, i) => (
                                    <div key={i} className="rounded-3 p-3 p-md-4 mb-3" style={{ backgroundColor: '#EDEAE3' }}>
                                        <h6 className="fw-bold mb-3">
                                            <i className={`bi ${s.icon} me-2`} style={{ color: '#2D6A4F' }}></i>{s.title}
                                        </h6>
                                        <ul className="text-muted small mb-0 ps-3">
                                            {s.items.map((item, j) => <li key={j} className="mb-1">{item}</li>)}
                                        </ul>
                                ...
                                <div className="rounded-3 p-3 p-md-4" style={{ backgroundColor: '#EDEAE3' }}>
                                    <h6 className="fw-bold mb-3">
                                        <i className="bi bi-shield-check me-2" style={{ color: '#2D6A4F' }}></i>Payment Methods
                                    </h6>
                                    <div className="d-flex gap-2 flex-wrap">
                    ...
                    {activeTab === 'reviews' && (
                        <div>
                                ...
                                {reviews.length > 0 ? (
                                    <div className="d-flex align-items-center gap-3 gap-md-4">
                                        <div className="text-center">
                                            <div className="fw-bold" style={{ fontSize: 44, color: '#2D6A4F', lineHeight: 1 }}>
                                                {avgRating.toFixed(1)}
                                            </div>
                            ...
                            {/* Review form */}
                            {showReviewForm && (
                                <div className="rounded-3 p-3 p-md-4 mb-4"
                                     style={{ backgroundColor: '#FDFAF5', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
                                    <h5 className="fw-bold mb-3 mb-md-4">Write Your Review</h5>
                                    <form onSubmit={handleSubmitReview}>
                                        <div className="mb-3">
                                            ...
                                            <div className="d-flex align-items-center gap-2 gap-md-3 flex-wrap">
                                                <Stars rating={reviewForm.rating} size={30} interactive
                            ...
                            {reviews.length === 0 ? (
                                <div className="text-center py-5 text-muted">
                                    <i className="bi bi-chat-square-text" style={{ fontSize: 44, color: '#ccc' }}></i>
                                    <p className="mt-3 mb-0">No reviews yet. Be the first to review this product!</p>
                                </div>
                            ) : (
                                <div className="d-flex flex-column gap-3">
                                    {reviews.map(review => (
                                        <div key={review.reviewId} className="rounded-3 p-3 p-md-4"
                                                    ...
                                                    {review.isVerifiedPurchase && (
                                                        <div className="mt-1">
                                                            <span className="badge"
                                                                  style={{ backgroundColor: '#D4EDDA', color: '#2D6A4F', fontSize: 10 }}>
                ...
                {relatedProducts.length > 0 && (
                    <div>
                        <div className="d-flex justify-content-between align-items-center mb-3 mb-md-4">
                            <h4 className="fw-bold mb-0" style={{ fontSize: 'clamp(1.1rem, 3vw, 1.5rem)' }}>
                                You May Also Like
                            </h4>
