    ...
    return (
        <div className="container-fluid vh-100 d-flex p-0">
            ...
            <div className="col-12 col-lg-6 d-flex align-items-center justify-content-center bg-white">
                {/*
                  KEY FIX: was `width: '450px'` which caused horizontal overflow on phones.
                  Now uses maxWidth + 100% width + responsive padding.
                */}
                <div className="auth-form-panel w-100"
                     style={{ maxWidth: 450, padding: 'clamp(1.25rem, 5vw, 2rem)' }}>

                    <div className="text-center mb-4">
                        {/* Logo visible only on mobile (illustration panel is hidden) */}
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="input-group">
                                <input type="password" className="form-control p-3 border-end-0"
                                       placeholder="Enter your password"
                                       value={password} onChange={(e) => setPassword(e.target.value)} required />
                                <span className="input-group-text bg-white border-start-0">👁️</span>
                            </div>
                        </div>
