        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KycDocumentPath = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepairQuoteId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RepairRequestId = table.Column<int>(type: "integer", nullable: false),
                    SellerId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairQuotes", x => x.RepairQuoteId);
                    table.ForeignKey(
                        name: "FK_RepairQuotes_RepairRequests_RepairRequestId",
                        column: x => x.RepairRequestId,
                        principalTable: "RepairRequests",
                        principalColumn: "RepairRequestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairQuotes_Sellers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Sellers",
                        principalColumn: "SellerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Chairs", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Bamboo and cane chairs" },
                    { 2, "Tables", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Bamboo and cane tables" },
                    { 3, "Storage", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Storage furniture" },
                    { 4, "Decorative", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Decorative items" },
                    { 5, "Outdoor", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Outdoor furniture" }
                });

            migrationBuilder.InsertData(
                table: "Materials",
                columns: new[] { "MaterialId", "CreatedAt", "Description", "MaterialName" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Natural bamboo", "Bamboo" },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Natural cane", "Cane" },
                    { 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Natural rattan", "Rattan" },
                    { 4, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Mixed materials", "Mixed" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairQuotes_RepairRequestId",
                table: "RepairQuotes",
                column: "RepairRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairQuotes_SellerId",
                table: "RepairQuotes",
                column: "SellerId");
